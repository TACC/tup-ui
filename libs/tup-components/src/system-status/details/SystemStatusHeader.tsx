...
import { LoadingSpinner, SectionHeader, InlineMessage } from '@tacc/core-components';
...
export const SystemStatusHeader: React.FC<SystemDetailProps> = ({
  tas_name = 'frontera'
    ...
    if (error)
    return (
      <SectionHeader className={`${styles['system-header']}`}><InlineMessage type="warn">System Status / Unable to retrieve system name</InlineMessage></SectionHeader>
    );
